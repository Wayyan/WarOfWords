...
public class normal_fragment2  extends Fragment implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    private com.team12.warofwords.entity.Normal Normal = AppDatabase.getAppDatabase(getContext()).normalDAO().findByID(2);
    ...
    private int[] gameCountList = new int[]{R.id.v1, R.id.v2, R.id.v3, R.id.v4, R.id.v5,R.id.v6,R.id.v7,R.id.v8};
    ...
    private String loadJSONFromAsset() {
        ...
        try {
            InputStream is = getActivity().getAssets().open("normal2.json");

...
public class normal_fragment3 extends Fragment implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    private com.team12.warofwords.entity.Normal Normal = AppDatabase.getAppDatabase(getContext()).normalDAO().findByID(3);
    ...
    private int[] gameCountList = new int[]{R.id.v1, R.id.v2, R.id.v3, R.id.v4, R.id.v5,R.id.v6,R.id.v7,R.id.v8,R.id.v9,R.id.v10};
    ...
    public normal_fragment3() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_normal3, container, false);
    ...
    private void prepareNormalData() {
        ...
        try {
            ...
            for (int i = 0; i < arrJSON.length(); i++) {
                ...
                normal1 normal = new normal1(objJSON.getString("question"), objJSON.getString("answers"), objJSON.getString("ranswer"));
    ...
    private String loadJSONFromAsset() {
        ...
        try {
            InputStream is = getActivity().getAssets().open("normal3.json");
    ...
    private void getRandomData() {
        ...
        rigthAnswer = normal1.getRightAnswer();

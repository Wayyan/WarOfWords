...
public class intermediate_fragment3 extends Fragment implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    public intermediate_fragment3() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_intermediate3, container, false);
    ...
    private String loadJSONFromAsset() {
        ...
        try {
            InputStream is = getActivity().getAssets().open("intermediate3.json");

...
public class intermediate_fragment1 extends Fragment implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    private com.team12.warofwords.entity.Intermediate Intermediate = AppDatabase.getAppDatabase(getContext()).intermediateDAO().findByID(1);
    ...
    public intermediate_fragment1() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_intermediate1, container, false);
    ...
    private String loadJSONFromAsset() {
        ...
        try {
            InputStream is = getActivity().getAssets().open("intermediate1.json");
    ...
    public void doOkay() {
        switch (btnOkay.getText().toString()) {
            ...
            case "NEXT":
                ...
                btnOkay.setEnabled(false);break;
